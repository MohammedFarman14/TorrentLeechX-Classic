...
LEECH_COMMAND = os.environ.get("LEECH_COMMAND", "leechvideo1")
LEECH_UNZIP_COMMAND = os.environ.get("LEECH_UNZIP_COMMAND", "leechunzip1")
LEECH_ZIP_COMMAND = os.environ.get("LEECH_ZIP_COMMAND", "leechzip1")
...
TELEGRAM_LEECH_UNZIP_COMMAND = os.environ.get(
    "TELEGRAM_LEECH_UNZIP_COMMAND", "tleechunzip1")
...
HELP_COMMAND = os.environ.get("HELP_COMMAND", "help1")
